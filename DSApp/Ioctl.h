...
/*----------------------------------------
    IOCTL Functions
----------------------------------------*/
// Func TestIoctl(HANDLE * DriverDeviceHandle)
// IN: DriverDeviceHandle -> Handle pointer to device for driver IOCTLS
// SUMMARY: Will do a simple test a BUFFERED IOCTL
DWORD
...
#define TEST_IOCTL_BUFFERED CTL_CODE(SIOCTL_TYPE, 0x900, METHOD_BUFFERED, FILE_ANY_ACCESS)
